...
INSERT INTO MusiCrowd.Projet (user_id, nom_proj, description, date_deb, date_fin, objectif, somme_recoltee, taxe_perc, termine) VALUES (1, 'boite de musique à manger', 'manger la musique au lieu de l écouter', NOW(), '2019-05-26', 200000, 0, 10, FALSE);
INSERT INTO MusiCrowd.Projet (user_id, nom_proj, description, date_deb, date_fin, objectif, somme_recoltee, taxe_perc, termine) VALUES (2, 'Music 4 the Proo', 'musique pour les pro ps4 only', '2019-05-15', '2019-05-23', 2000, 0, 50, FALSE);
INSERT INTO MusiCrowd.Projet (user_id, nom_proj, description, date_deb, date_fin, objectif, somme_recoltee, taxe_perc, termine) VALUES (1, 'guitare pour les manchots', 'pour que la musique soit accessible à tous', NOW(), '2019-05-10', 1000000, 0, 5, FALSE);
INSERT INTO MusiCrowd.Projet (user_id, nom_proj, description, date_deb, date_fin, objectif, somme_recoltee, taxe_perc, termine) VALUES (2, 'Music 3 the Proo', 'musique pour les amateurs', NOW(), '2019-05-1', 300000, 0, 15, FALSE);
